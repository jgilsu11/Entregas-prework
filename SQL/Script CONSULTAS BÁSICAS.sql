...
select  "Name" as "Track_Title", "Milliseconds" 
from "Track" 
...
select "FirstName" as "First_Name", "LastName" as "Last_Name", "ReportsTo" 
from "Employee"
where "ReportsTo" = 1;
...
select "Name" as "Track_Name", "Milliseconds"  as "Duration", "UnitPrice" 
from "Track"
...
select "City", "State" , "FirstName" , "LastName" 
from "Employee"
...
select "Country" ,"FirstName" ,"CustomerId" ,"SupportRepId" 
from "Customer"
...
select "Milliseconds" , "Name" , "MediaTypeId" 
from "Track"
