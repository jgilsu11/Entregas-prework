...
select "AlbumId" as "ALBUM", COUNT ("TrackId") as "CANCIONES" 
from "Track"
group by "AlbumId" 
...
select "Composer", AVG("Milliseconds") as "Media", stddev("Milliseconds") as "Desviacion", variance("Milliseconds") as "Varianza"
from "Track"
group by ("Composer");
...
select "MediaTypeId" , count("TrackId") as "Cantidad de pistas" 
from "Track"
...
select "Country" , "State", COUNT("CustomerId") as "Numero_de_clientes" 
from "Customer" 
where "Customer"."SupportRepId" > 3 and "Customer"."Company" is not null
